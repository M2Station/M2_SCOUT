...
(function () {
  ...
  // Army (military tactical black + olive drab + burnt orange):
  // Deep black background with dark olive panels, burnt orange accent.
  // High contrast tactical aesthetic with premium black finish.
  ...
  const ARMY = Object.assign({}, LOW_KEY, {
    ...
    '--debug-border': '#404530',
    '--ctxmenu-bg': '#232815',
    '--ctxmenu-border': '#404530',
    '--ctxmenu-hover': '#2d3420',
    '--syn-comment': '#8a8973',
    '--syn-string': '#c8d17a',
    '--syn-number': '#e0b050',
    '--syn-keyword': '#f5a520',
    '--syn-type': '#d8db7a',
    '--syn-decorator': '#e8a030',
    '--syn-common_kw': '#e8832a',
  });
