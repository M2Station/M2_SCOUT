...
(function () {
  const STRINGS = {
    en: {
      ...
      'folderpick.title': 'Select Folder (keyboard)',
      'folderpick.filter': 'Type to filter\u2026',
      'folderpick.hint': 'Up/Down move | Enter select | Right open | Backspace up | Esc cancel',
      'folderpick.up': 'Up',
      'folderpick.select': 'Select',
      'folderpick.cancel': 'Cancel',
      'folderpick.thisPc': 'This PC',
      'folderpick.empty': 'No subfolders',

      'history.button': 'Search history',
      'history.title': 'Recent keywords',
      ...
      'form.or': 'OR',
      'form.and': 'AND',
      'form.orTip': 'OR: show a file if it matches ANY of the space-separated keywords.',
      'form.andTip': 'AND: show a file only if it matches ALL of the space-separated keywords (the matches may be on different lines).',
      ...
      'form.previewContextLines': 'Preview context lines',
      'form.editor': 'Editor',
      ...
      'files.filter': 'Filter:',
      'files.clear': 'Clear',
      'files.hint': 'F1:copy  F2:HL  F3:Dim  F4:Clr  Enter:open  Ctrl/Shift:multi',
      'files.matches': 'Matches:',
      'files.viewList': '\u2630 List',
      'files.viewTree': '\u229E Tree',
      'files.viewToggle': 'Toggle List / Tree',
      'files.sortByPath': '\u21C5 Name',
      'files.sortByCount': '\u21C5 Count',
      'files.sortToggle': 'Sort: Name / Count',
      'files.openManyConfirm': 'Open {n} files in the editor?',
      'files.openManyExplorerConfirm': 'Open {n} folders in File Explorer?',
      ...
      'ctx.openFiles': 'Open {n} files in Editor',
      'ctx.openFilesExplorer': 'Open in File Explorer',
      'ctx.compareBeyond': 'Compare in Beyond Compare',
      ...
      'update.noAsset': 'No download asset for the selected platform',

      'appUpdate.button': 'Check for update',
      'appUpdate.title': 'M2_SCOUT update',
      'appUpdate.version': 'App version',
      'appUpdate.checking': 'Checking for updates\u2026',
      'appUpdate.upToDate': 'You already have the latest version',
      'appUpdate.available': 'A new version is available.\nCurrent: v{cur}\nLatest: v{latest}',
      'appUpdate.installDetail': 'Download the installer and run it now? The app will close to finish installing, then reopen.',
      'appUpdate.downloadInstall': 'Download & Install',
      'appUpdate.cancel': 'Cancel',
      'appUpdate.downloading': 'Downloading the installer\u2026',
      'appUpdate.launched': 'The installer has started. Follow its prompts to finish updating.',
      'appUpdate.noAsset': 'No installer found for this system',
      'appUpdate.checkFailed': 'Update check failed',
    ...
    'zh-TW': {
      ...
      'exfolder.count': '\u5DF2\u9078 {n}',
      'folderpick.title': '\u9078\u64C7\u8CC7\u6599\u593E\uFF08\u9375\u76E4\uFF09',
      'folderpick.filter': '\u8F38\u5165\u540D\u7A31\u7BE9\u9078\u2026',
      'folderpick.hint': '\u2191\u2193 \u79FB\u52D5 | Enter \u9078\u53D6 | \u2192 \u9032\u5165 | Backspace \u4E0A\u5C64 | Esc \u53D6\u6D88',
      'folderpick.up': '\u4E0A\u5C64',
      'folderpick.select': '\u9078\u53D6',
      'folderpick.cancel': '\u53D6\u6D88',
      'folderpick.thisPc': '\u672C\u6A5F',
      'folderpick.empty': '\uFF08\u6C92\u6709\u5B50\u8CC7\u6599\u593E\uFF09',

      'history.button': '\u641C\u5C0B\u7D00\u9304',
      'history.title': '\u6700\u8FD1\u7684\u95DC\u9375\u5B57',
      'history.empty': '\uFF08\u5C1A\u7121\u7D00\u9304\uFF09',
      'history.delete': '\u522A\u9664',
      'history.cancel': '\u95DC\u9589',
      'form.keywords': '\u95DC\u9375\u5B57',
      ...
      'form.or': 'OR',
      'form.and': 'AND',
      'form.orTip': 'OR\uFF1A\u7B26\u5408\u4EFB\u4E00\u95DC\u9375\u5B57\uFF08\u4EE5\u7A7A\u767D\u5206\u9694\uFF09\u7684\u6A94\u6848\u5C31\u986F\u793A\u3002',
      'form.andTip': 'AND\uFF1A\u9700\u540C\u6642\u7B26\u5408\u6240\u6709\u95DC\u9375\u5B57\uFF08\u4EE5\u7A7A\u767D\u5206\u9694\uFF0C\u53EF\u5728\u4E0D\u540C\u884C\uFF09\u7684\u6A94\u6848\u624D\u986F\u793A\u3002',
      'form.caseSensitive': '\u5340\u5206\u5927\u5C0F\u5BEB',
      'form.respectIgnore': '\u9075\u5FAA (.gitignore/.ignore/.rgignore)',
      'form.editorCmd': '\u7DE8\u8F2F\u5668\u6307\u4EE4',
      'form.editorArgs': '\u7DE8\u8F2F\u5668\u53C3\u6578\uFF08\u7BC4\u672C\uFF09',
      'form.previewContextLines': 'Preview \u4E0A\u4E0B\u884C\u6578',
      'form.editor': '\u7DE8\u8F2F\u5668',
      'editor.button': '\u7DE8\u8F2F\u5668\u2026',
      'editor.none': '\uFF08\u672A\u8A2D\u5B9A\uFF09',
      ...
      'files.filter': '\u7BE9\u9078\uFF1A',
      'files.clear': '\u6E05\u9664',
      'files.hint': 'F1:\u8907\u88FD  F2:\u6A19\u4EAE  F3:\u6DE1\u5316  F4:\u6E05\u9664  Enter:\u958B\u555F  Ctrl/Shift:\u591A\u9078',
      'files.matches': '\u7B26\u5408\uFF1A',
      'files.viewList': '\u2630 \u6E05\u55AE',
      'files.viewTree': '\u229E \u6A39\u72C0',
      'files.viewToggle': '\u5207\u63DB\u6E05\u55AE / \u6A39\u72C0',
      'files.sortByPath': '\u21C5 \u540D\u7A31',
      'files.sortByCount': '\u21C5 \u6578\u91CF',
      'files.sortToggle': '\u6392\u5E8F\uFF1A\u540D\u7A31 / \u6578\u91CF',
      'files.openManyConfirm': '\u8981\u5728\u7DE8\u8F2F\u5668\u4E2D\u958B\u555F {n} \u500B\u6A94\u6848\uFF1F',
      'files.openManyExplorerConfirm': '\u8981\u5728\u6A94\u6848\u7E3D\u7BA1\u958B\u555F {n} \u500B\u8CC7\u6599\u593E\uFF1F',
      'files.collapseAll': '\u5168\u90E8\u6536\u5408',
      'files.expandAll': '\u5168\u90E8\u5C55\u958B',
      'preview.title': '\u9810\u89BD',
      'status.ready': '\u5C31\u7DD2\u3002',
      ...
      'ctx.openFiles': '\u5728\u7DE8\u8F2F\u5668\u958B\u555F {n} \u500B\u6A94\u6848',
      'ctx.openFilesExplorer': '\u5728\u6A94\u6848\u7E3D\u7BA1\u958B\u555F',
      'ctx.compareBeyond': '\u5728 Beyond Compare \u4E2D\u6BD4\u5C0D',
      ...
      'update.done': '\u5DF2\u66F4\u65B0\u81F3',
      'update.noAsset': '\u627E\u4E0D\u5230\u5C0D\u61C9\u5E73\u53F0\u7684\u4E0B\u8F09\u6A94',

      'appUpdate.button': '\u6AA2\u67E5\u65B0\u7248\u672C',
      'appUpdate.title': 'M2_SCOUT \u66F4\u65B0',
      'appUpdate.version': '\u7A0B\u5F0F\u7248\u672C',
      'appUpdate.checking': '\u6AA2\u67E5\u66F4\u65B0\u4E2D\u2026',
      'appUpdate.upToDate': '\u5DF2\u662F\u6700\u65B0\u7248\u672C',
      'appUpdate.available': '\u6709\u65B0\u7248\u672C\u53EF\u7528\u3002\n\u76EE\u524D\uFF1Av{cur}\n\u6700\u65B0\uFF1Av{latest}',
      'appUpdate.installDetail': '\u8981\u7ACB\u5373\u4E0B\u8F09\u4E26\u57F7\u884C\u5B89\u88DD\u7A0B\u5F0F\u55CE\uFF1F\u5B89\u88DD\u6642\u61C9\u7528\u7A0B\u5F0F\u6703\u95DC\u9589\uFF0C\u5B8C\u6210\u5F8C\u81EA\u52D5\u91CD\u65B0\u958B\u555F\u3002',
      'appUpdate.downloadInstall': '\u4E0B\u8F09\u4E26\u5B89\u88DD',
      'appUpdate.cancel': '\u53D6\u6D88',
      'appUpdate.downloading': '\u4E0B\u8F09\u5B89\u88DD\u7A0B\u5F0F\u4E2D\u2026',
      'appUpdate.launched': '\u5B89\u88DD\u7A0B\u5F0F\u5DF2\u555F\u52D5\uFF0C\u8ACB\u4F9D\u756B\u9762\u6307\u793A\u5B8C\u6210\u66F4\u65B0\u3002',
      'appUpdate.noAsset': '\u627E\u4E0D\u5230\u9069\u7528\u65BC\u6B64\u7CFB\u7D71\u7684\u5B89\u88DD\u7A0B\u5F0F',
      'appUpdate.checkFailed': '\u6AA2\u67E5\u66F4\u65B0\u5931\u6557',
      'appUpdate.downloadFailed': '\u4E0B\u8F09\u5931\u6557',
